...
export function HomePage() {
  const events = [
    ...
    },
    {
      ...
      description:
        "From vibrant festivals to intimate workshops, we've shared our passion for Brazilian Zouk across continents. Each event is a unique celebration of dance, music, and cultural connection.",
      type: "text",
      media: null,
    },
  ];
  ...
  return (
    <div className="relative">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-black">
        ...
        <div className="container relative z-10">
          <motion.div className="max-w-4xl mx-auto text-center" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            <motion.h1
              className="text-5xl md:text-7xl font-serif font-display font-bold mb-6 text-white"
            ...
            <motion.h2
              className="text-3xl md:text-5xl  font-display font-bold mb-6 text-slate-300"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.2, duration: 0.8 }}
            >
            ...
            <motion.p className="text-xl md:text-2xl text-gray-300 mb-8" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4, duration: 0.8 }}>
      ...
      <section className="py-24 bg-black">
        <div className="container">
          <motion.div className="text-center mb-12" initial={{ opacity: 0, y: -20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }}>
            <h2 className="text-4xl md:text-5xl font-display font-bold text-white mb-4">2025 Tour Schedule</h2>
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">Join us at dance events around the world</p>
          </motion.div>
          <TourSchedule />
        </div>
      </section>
      ...
      <section className="relative py-16 bg-black overflow-hidden">
        <div className="">
          <motion.div className="text-center mb-12" initial={{ opacity: 0, y: -20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }}>
            <h2 className="text-4xl md:text-5xl font-display font-bold text-white mb-4">Follow Us</h2>
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">Join us at dance events around the world</p>
          </motion.div>
      ...
      <section className="relative py-24 bg-gradient-to-b from-gray-900 to-black">
        <div className="container">
          <motion.div className="text-center mb-16" initial={{ opacity: 0, y: -20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }}>
            <h2 className="text-4xl md:text-5xl font-display font-bold text-white mb-4">What We Do</h2>
          ...
          >
            <a href="/contact" className="inline-flex items-center px-6 py-3 rounded-full bg-white/10 hover:bg-white/20 text-white transition-colors">
              Book Us Now
          ...
          >
            <div>
              ...
              <p className="text-gray-300 mb-6">
                Brazilian, born in 1998, Nina started her dance journey with Classic ballet at age 5. She specializes in Zouk, Lambada, High Heels, and Lady Style, bringing a young
                and creative approach to her dance and teaching methodology.
              </p>
              <p className="text-gray-300">
                She is recognized for her musicality, autonomy and expressiveness that make her dance unique. Teacher, actress, performer and one of the directors of Barracão da
                Dança, she brings in her curriculum numerous achievements in competitions and festivals, both national and international.
              </p>
            </div>
            <div className="aspect-square rounded-lg overflow-hidden">
              <Image src="https://i.imgur.com/c1uDcqL.jpeg" alt="Nina Darbello" width={600} height={600} className="w-full h-full object-cover" />
            </div>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container">
          ...
          >
            <div className="order-2 lg:order-1 aspect-square rounded-lg overflow-hidden">
              <Image src="https://i.imgur.com/WI4qc4o.jpeg" alt="Matheus Franco" width={600} height={600} className="w-full h-full object-cover" />
            </div>
            <div className="order-1 lg:order-2">
              <h2 className="text-3xl font-bold mb-6 text-white">Matheus Franco</h2>
              <p className="text-gray-300 mb-6">
                Brazilian, born in 1990, Matheus discovered his passion for dance at 13 but started at 20. His journey began with Classical and Contemporary Ballet, Hip-Hop and
                Jazz, before finding his true calling in Brazilian Zouk and social dances.
              </p>
              <p className="text-gray-300">
                Currently working alongside Nina Darbello, they focus on Brazilian Zouk and Lambada, teaching at the biggest Zouk/Lambada congresses worldwide. As co-owner and
                director of Barracão da Dança, he helps manage a thriving community of over 320 students in Campinas-SP.
              </p>
            </div>
          </motion.div>
        </div>
